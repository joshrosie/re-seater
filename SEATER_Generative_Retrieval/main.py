...
def main():
    ...
    parser.add_argument('--tb', type=bool, help='whether use tensorboard (record metrics)', default=False, action=argparse.BooleanOptionalAction)
    parser.add_argument('--train_tb', type=bool, help='whether use tensorboard to record loss', default=False, action=argparse.BooleanOptionalAction)
    ...
    parser.add_argument('--use_wandb', type=bool, help='whether to use Weights & Biases for logging', default=True, action=argparse.BooleanOptionalAction)
    parser.add_argument('--wandb_project', type=str, help='WandB project name', default='seater')
    parser.add_argument('--wandb_entity', type=str, help='WandB entity/username', default=None)
